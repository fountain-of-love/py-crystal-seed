...
REQUIRED_DOCS: set[str] = {
    ...
    "docs/maturity/governance-auditability/coverage-governance-guardrail.md",
    "docs/maturity/governance-auditability/maturity-evidence-guardrail.md",
    "docs/maturity/governance-auditability/governance-log-contract.md",
    "docs/maturity/governance-auditability/weekly-governance-reporting.md",
    "docs/maturity/governance-auditability/guard-telemetry-model.md",
    "docs/maturity/governance-auditability/architecture-manifest-recipes.md",
    "docs/adr/README.md",
